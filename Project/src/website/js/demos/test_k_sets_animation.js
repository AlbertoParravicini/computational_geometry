...
(function() {
  ...
  zonoids_k_sets_anim_demo = function(p_o) {
    var animation_duration, build_zonoid, canvas_mouseWheel, current_duration, current_k_set, default_color, draw_poly, h, input_points, k, k_set_num, k_sets, label, m_sep, num_input_points, q_sep, select_event, sep_p1, sep_p2, slider, start_animation, w, zonoid;
    ...
    p_o.draw = function() {
      ...
      if (build_zonoid && start_animation) {
        ...
        if (current_k_set < k_sets.length - 1) {
          ...
          build_zonoid = false;
          current_duration = 0;
          return slider.removeAttribute("disabled");
        }
      } else {
