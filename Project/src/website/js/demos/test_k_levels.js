...
(function() {
  ...
  zonoids_k_level_demo = function(p_o) {
    ...
    p_o.draw = function() {
      var i, i1, j, j1, l, l_i, len, len1, len2, len3, len4, len5, len6, len7, m, n, o, p, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, s, t, u, v, x, y, z, z_i, zonoid_slice_d, zonoid_slice_u, zonoid_temp;
      ...
      if (zonoid_temp.length > 0) {
        return draw_poly(p_o, radial_sort(zonoid_temp, {
