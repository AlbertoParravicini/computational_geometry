...
(function() {
  ...
  zonoids_k_level_intersection_demo = function(p_o) {
    ...
    p_o.draw = function() {
      ...
      draw_poly(p_o, [new Point(w / 2, 0), new Point(w, 0), new Point(w, h), new Point(w / 2, h)], {
      ...
      if (p_o.mouseX >= 0 && p_o.mouseX <= w && p_o.mouseY >= 0 && p_o.mouseY <= h) {
        ...
        p_o.strokeWeight(8);
        ref11 = [(p_o.mouseX - 0.75 * w) / (2 * scale_factor), (p_o.mouseY - 100) / scale_factor], p_x = ref11[0], p_y = ref11[1];
