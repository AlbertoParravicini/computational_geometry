...
var canvas_bound_original, default_color, draw, draw_poly, dual_lines, h, input_points, k, k_level_d, k_level_u, leftmost_point, mouseWheel, num_input_points, reflex_vertices_d, reflex_vertices_u, rightmost_point, scale_factor, setup, w, zonoid, zonoid_lines, zonoid_vertices_d, zonoid_vertices_u;
...
draw = function() {
  var i, i1, j, j1, k_level_d_temp, k_level_u_temp, l, l_i, len, len1, len2, len3, len4, len5, len6, len7, m, n, o, p, p_x, p_y, q, r, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, res, s, t, u, v, x, y, z, z_i, zonoid_slice_d, zonoid_slice_u, zonoid_temp, zonoid_vertices_d_temp, zonoid_vertices_u_temp;
  ...
  if (zonoid_temp.length > 0) {
    res = check_inclusion_in_polygon(radial_sort(zonoid_temp, {
      anchor: leftmost_point(zonoid_temp),
      cw: true
    }), new Point(mouseX, mouseY));
  }
  if (zonoid_temp.length > 0 && res) {
    draw_poly(radial_sort(zonoid_temp, {
      anchor: leftmost_point(zonoid_temp),
      cw: true
    }), {
  ...
  } else if (zonoid_temp.length > 0 && !res) {
    draw_poly(radial_sort(zonoid_temp, {
      anchor: leftmost_point(zonoid_temp),
      cw: true
    }), {
  ...
  for (j1 = 0, len7 = ref10.length; j1 < len7; j1++) {
    l_i = ref10[j1];
  ...
  strokeWeight(8);
  ref11 = [(mouseX - 0.75 * w) / (2 * scale_factor), (mouseY - 100) / scale_factor], p_x = ref11[0], p_y = ref11[1];
