...
input_points = [new Point(2, -2), new Point(-0.8, 4.2), new Point(1, 3), new Point(0.1, 0.6), new Point(0.4, 1.2), new Point(-0.2, 2.2), new Point(1.4, 0.3), new Point(-0.3, 4.8), new Point(-0.2, 6), new Point(3, -10)];
...
draw = function() {
  var i, j, l, len, len1, len2, len3, len4, m, n, o, p, q, r, ref, ref1, ref2, ref3, results, s, t, u, y;
  ...
  for (u = 0, len4 = zonoid_vertices_d.length; u < len4; u++) {
    ...
    results.push(ellipse(p.x, p.y, 20, 20));
  }
  return results;
};
