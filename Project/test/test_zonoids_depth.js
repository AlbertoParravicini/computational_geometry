...
var default_color, draw, draw_poly, h, i, input_points, j, k, leftmost_point, num_input_points, query_point, ref, ref1, setup, w, zonoid, zonoid_list;
...
draw = function() {
  ...
  for (m = 0, len1 = zonoid_list.length; m < len1; m++) {
    zonoid_i = zonoid_list[m];
    for (n = 0, len2 = zonoid_i.length; n < len2; n++) {
      z_i = zonoid_i[n];
      fill(16, 74, 34, 60);
      stroke(16, 74, 34, 255);
  ...
  if (k_depth > 0) {
    ...
    for (o = 0, len3 = zonoid.length; o < len3; o++) {
      z_i = zonoid[o];
      fill(16, 74, 34, 165);
      stroke(16, 74, 34, 255);
...
draw_poly = function(points, arg) {
  var fill_color, l, len, p_i, ref2, stroke_color;
  ref2 = arg != null ? arg : {}, fill_color = ref2.fill_color, stroke_color = ref2.stroke_color;
  if (fill_color == null) {
