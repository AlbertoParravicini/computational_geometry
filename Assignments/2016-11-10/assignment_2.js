...
var Point, binary_search, convex_hull_graham_scan, find_intersecting_edge, find_tangents, find_tangents_bin_search, hull, inclusion_in_hull, new_point, orientation_test, point_inside_triangle, points, radial_sort, squared_distance, swap;
...
find_tangents = function(input_points, new_point) {
  var e_next, e_prev, i, j, ref, v_l, v_r;
  points = input_points.slice();
...
find_tangents_bin_search = function(input_points, new_point) {
  var intersecting_edge, middle, middle_bottom, middle_top, o_bottom_1, o_bottom_2, o_top_1, o_top_2, start, start_top, stop, stop_bottom, v_b, v_t;
  ...
  console.log("v_b: ", middle_bottom);
  console.log("v_t: ", middle_top);
  return [true, v_b, v_t];
};
